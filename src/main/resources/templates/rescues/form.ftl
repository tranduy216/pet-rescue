    ...
    <div class="bg-white rounded-xl shadow-md p-8">
        ...
        <form method="POST" action="/rescues/new" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="4" required placeholder="${msg['rescue_field_description_placeholder']!'Describe the animal and situation...'}"
            ...
            <div class="flex space-x-3">
                <button type="submit" class="bg-yellow-500 text-white px-6 py-2 rounded-lg hover:bg-yellow-600">${msg['rescue_submit']!'Submit Report'}</button>
