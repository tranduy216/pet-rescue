...
object Messages {
    ...
    private val vi: Map<String, String> = mapOf(
        ...
        // Wishes management
        "wish_page_title" to "💌 Quản Lý Lời Chúc",
        "wish_col_sender" to "Người Gửi",
        "wish_col_message" to "Nội Dung",
        "wish_col_status" to "Trạng Thái",
        "wish_col_date" to "Ngày",
        "wish_col_actions" to "Thao Tác",
        "wish_status_pending" to "Chờ Duyệt",
        "wish_status_approved" to "Đã Duyệt",
        "wish_status_received" to "Đã Nhận",
        "wish_btn_approve" to "Duyệt",
        "wish_btn_receive" to "Đã Nhận",
        "wish_empty" to "Chưa có lời chúc nào.",
        "wish_delete_confirm" to "Xóa lời chúc này?",
        "wish_section_title" to "💌 Lời Chúc Từ Cộng Đồng",
        "wish_section_subtitle" to "Những lời động viên ấm áp từ mọi người dành cho trạm cứu hộ",
        "home_wishes_from" to "— ",
    ...
    private val en: Map<String, String> = mapOf(
        ...
        // Wishes management
        "wish_page_title" to "💌 Manage Wishes",
        "wish_col_sender" to "Sender",
        "wish_col_message" to "Message",
        "wish_col_status" to "Status",
        "wish_col_date" to "Date",
        "wish_col_actions" to "Actions",
        "wish_status_pending" to "Pending",
        "wish_status_approved" to "Approved",
        "wish_status_received" to "Received",
        "wish_btn_approve" to "Approve",
        "wish_btn_receive" to "Mark Received",
        "wish_empty" to "No wishes yet.",
        "wish_delete_confirm" to "Delete this wish?",
        "wish_section_title" to "💌 Community Wishes",
        "wish_section_subtitle" to "Warm words of encouragement for the rescue station",
        "home_wishes_from" to "— ",
